                ...
                <div class="team3">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{url('storage')}}/founding/{{$f->avatar}}" alt="wrapkit" class="img-fluid" />
                                </div>
                                <div class="col-md-12">
                                        <center>
                               ...
                               <br>
                                        <center><div class="social-link">
                                            ...
                                            @if(!empty($f->facebook))<a href="{{$f->facebook}}" target="_blank"><i
                                                    ...
                                                    @endif
                                                    @if(!empty($f->instagram))<a href="{{$f->instagram}}" target="_blank"><i
                                                        class='bx bxl-instagram'></i></a>
                                                        @endif
                                                        @if(!empty($f->twitter))<a href="{{$f->twitter}}" target="_blank"><i
                                                            class='bx bxl-twitter'></i></a>
                                                            @endif
                                                            @if(!empty($f->linkedin))<a href="{{$f->linkedin}}" target="_blank"><i
