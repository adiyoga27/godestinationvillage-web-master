    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/perencanaan.svg" width="150px"
                        alt=""></div>
...
<div class="modal fade" id="projectmanagement" tabindex="-1" role="dialog" aria-labelledby="perencanaan"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/kajian.svg" width="150px" alt="">
                </div>
...
<div class="modal fade" id="pengembangansdm" tabindex="-1" role="dialog" aria-labelledby="perencanaan"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/sdm.svg" width="150px" alt="">
                </div>
...
<div class="modal fade" id="branding" tabindex="-1" role="dialog" aria-labelledby="perencanaan" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/branding.svg" width="150px"
                        alt=""></div>
...
<div class="modal fade" id="tren" tabindex="-1" role="dialog" aria-labelledby="perencanaan" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/tren.svg" width="150px" alt="">
                </div>
...
<div class="modal fade" id="internship" tabindex="-1" role="dialog" aria-labelledby="perencanaan" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="services-icon mb-3 text-center"><img src="customer/img/etc/internship.png" width="150px"
                        alt=""></div>
